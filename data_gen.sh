...
for part in {0..7}; do
    ...
    CUDA_VISIBLE_DEVICES=$part python scripts/instruction_filter.py --data_json /test/annan/sft_data/AesEditor/data_json/ae_test_enhance.jsonl --save_json /test/annan/sft_data/Pexels/ae_test_${part}.jsonl --image_root /test/annan/sft_data/AesEditor --part 8-${part}
done


for part in {0..7}; do
    echo "Processing part ${part}"
    CUDA_VISIBLE_DEVICES=$part python scripts/instruction_filter.py --data_json /test/annan/sft_data/AesEditor/data_json/ae_train_enhance.jsonl --save_json /test/annan/sft_data/Pexels/ae_train_${part}.jsonl --image_root /test/annan/sft_data/AesEditor --part 8-${part}
done